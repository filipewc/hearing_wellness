...
def main():
    ...
    # hearing_issues -> bool se existir
    ...
    # prevalência geral de problemas auditivos
    ...
    print(f"[gold] gerado: {fact_out.name}, kpi_overview.parquet e cortes por age/gender se disponíveis")
